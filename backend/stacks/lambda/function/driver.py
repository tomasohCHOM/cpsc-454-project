...
class Driver:
    def __init__(self):
        ...
        self.upload_bucket = (
            "cdkstackstoragestack887cc089-uploadbucket13b7e0d9-teo1qw5fgcn6"
        )
        self.output_bucket = (
            "cdkstackstoragestack887cc089-outputbucket0b6601c4-alet4yallrbb"
        )
    ...
    def uploadMedia(self, data):
        self.s3_client.put_object(
            Bucket=self.upload_bucket, Key=self.key + ".flac", Body=data
        )
    ...
    def getTranscription(self) -> str:
        ...
        self.transcribe_client.start_transcription_job(
            ...
            LanguageCode="en-US",
            MediaFormat="flac",
            Media={"MediaFileUri": self.upload_file_uri + ".flac"},
